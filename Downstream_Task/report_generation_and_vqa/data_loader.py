    ...
    def __init__(self, args, data_set, file_src, image_root, split, batch_size, tokenizer, max_len, file_valid_jpgs, use_num_imgs=-1, short_sampling_prob=0.1, sent_reverse_order=False, bi_uni_pipeline=[], s2s_prob=0, bi_prob=1, tasks='report_generation'):
        ...
        if tasks == 'report_generation':
            ...
            for entry in self.entries:
                ...
                src_tk = '/home/cse/ckm/code/seelam/code/MedViLL/data/vqa_rad/home/mimic-cxr/dataset/data_RAD/img_preprocess/'+entry['image_name']
                # print(src_tk)
...
class Preprocess4Seq2seq(Pipeline):
    ...
    def __call__(self, instance):
        ...
        if fixed_path == '/home/mimic-cxr/dataset/vqa_image/vqa_512_3ch':
            fixed_path = '/home/cse/ckm/code/seelam/code/MedViLL/data/vqa_rad/home/mimic-cxr/dataset/data_RAD/img_preprocess/'
            img_path = fixed_path + static_path
        else:
            fixed_path ='/home/cse/ckm/code/seelam/code/MedViLL/data/home/data_storage/mimic-cxr/dataset/open_i/image_preprocessing/512_3ch/'
            img_path = fixed_path + static_path    
        # loading images
...
class Preprocess4Seq2seqDecoder(Pipeline):
    ...
    def __call__(self, instance):
        ...
        x=img_path.split("/")[-1]
        # print(x,os.getcwd())
        path="/home/cse/ckm/code/seelam/code/radiology_report_genration/MedViLL/home/data_storage/mimic-cxr/dataset/open_i/image_preprocessing/512_3ch/"+x
