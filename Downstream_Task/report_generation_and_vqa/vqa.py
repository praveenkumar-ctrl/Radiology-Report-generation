...
import sys
sys.path.insert(0, '/home/cse/ckm/code/seelam/code/MedViLL/downstream_task/classification')
from data.helpers import get_transforms
sys.path.insert(0, '/home/cse/ckm/code/seelam/code/MedViLL/CNN_BERT')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--src_file", type=str, default='/home/cse/ckm/code/seelam/code/MedViLL/data/vqa_rad/home/mimic-cxr/dataset/data_RAD')
    parser.add_argument("--img_path", type=str, default='/home/cse/ckm/code/seelam/code/MedViLL/data/vqa_rad/home/mimic-cxr/dataset/data_RAD/img_preprocess')
    parser.add_argument("--train_dataset", type=str,                           
                        default='/home/cse/ckm/code/seelam/code/MedViLL/data/vqa_rad/home/mimic-cxr/dataset/data_RAD/trainset.json',
                        help="train dataset for training")


    output_path = 'output_model/' + str(datetime.now())
    ...
    parser.add_argument("--load_pretrained_model", type=str,
                        default='/home/cse/ckm/code/seelam/code/MedViLL/downstream_task/report_generation_and_vqa/output_model/model.5.bin',
                        choices=['',
                                 'output/all/35',
                                 'output/chest/45'])
