...
if __name__ == '__main__':
    metric_pos1, metric_0, metric_neg1, metric_all = get_label_accuracy(hypothesis = '/home/cse/ckm/code/seelam/code/MedViLL/downstream_task/report_generation_and_vqa/output_model/labeled_reports.csv', reference = '/home/cse/ckm/code/seelam/code/MedViLL/downstream_task/report_generation_and_vqa/output_model/labeled_reports_gt.csv')
