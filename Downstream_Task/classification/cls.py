...
def get_args(parser):
    ...
    parser.add_argument("--loaddir", type=str, default='/home/cse/ckm/code/seelam/code/MedViLL/output/2022-09-04 17:00:29.561605/9')
    parser.add_argument("--name", type=str, default="scenario_name")


    parser.add_argument("--openi", type=bool, default=False)
    parser.add_argument("--data_path", type=str, default='/home/cse/ckm/code/seelam/code/MedViLL/data/mimic',
...
def model_forward(model, args, criterion, batch, device):
    ...
    if args.num_image_embeds > 0:
        for param in model.enc.img_encoder.parameters():  #changed
            param.requires_grad = args.freeze_img_all
    for param in model.enc.encoder.parameters(): #changed
