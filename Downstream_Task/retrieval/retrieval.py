...
class CXR_Retrieval_Dataset(Dataset):
    ...
    def data_processing(self, origin_txt, img_path):
        ...
        if fixed_path == '/home/mimic-cxr/dataset/image_preprocessing/re_512_3ch':
            fixed_path = '/home/cse/ckm/code/seelam/code/MedViLL/home/data_storage/mimic-cxr/dataset/image_preprocessing/re_512_3ch/'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--label_conditioned_valid_dataset", type=str,
                        ...
                        choices=['../../data/t2i/T2I_Label_Valid.jsonl',
                                 '../../data/i2t/I2T_Label_Valid.jsonl',
                                 '../../data/t2i/T2I_Label_Valid.jsonl',
                                 '../../data/i2t/I2T_Label_Valid.jsonl'])

    parser.add_argument("--label_conditioned_test_dataset", type=str,
                        default='../../data/t2i/T2I_Label_Test.jsonl',
                        help='label conditioned test dataset for evaluating the model',
                        choices=['../../data/t2i/T2I_Label_Test.jsonl',
                                 '../../data/i2t/I2T_Label_Test.jsonl',
                                 '../../data/t2i/T2I_Label_Test.jsonl',
                                 '../../data/i2t/I2T_Label_Test.jsonl'])
    ...
    parser.add_argument("--load_pretrained_model", type=str, default='/home/cse/ckm/code/seelam/code/MedViLL/output/2022-09-04 17:00:29.561605/9')  
